export const SupportersData = [
    ...
    },
    {
        ...
        trainings: "Till Now No.",  // The training data is "Till Now No.", not null or false
        consent: [
            "I agree to display my name, photo, and profile on the website.",
            "I agree to provide online psychosocial support as listed on the website."
        ],
    ...
    },
    {
        ...
        trainings: "PFA, Inclusive Leadership, Completed Disability Workshop",  // Training data exists
        consent: [
            "I agree to display my name, photo, and profile on the website.",
            "I agree to provide online psychosocial support as listed on the website."
        ],
    ...
    },
    {
        ...
        trainings: "Psycho-social support",  // Training data exists
        consent: [
            "I agree to display my name, photo, and profile on the website.",
            "I agree to provide online psychosocial support as listed on the website."
        ],
