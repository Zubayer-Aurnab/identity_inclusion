        ...
        <div className="relative">
            <div>
                <Swiper
                    ...
                    <SwiperSlide><img className='w-full h-[91vh] md:h-[93vh]  object-cover lg:object-contain' src={banner} alt="" /></SwiperSlide>
            ...
            <div
                ...
                className="absolute flex items-center h-32 md:h-56 w-full left-0 bottom-0 bg-gradient-to-r from-[#2b292b] z-10">
