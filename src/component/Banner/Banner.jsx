        ...
        <div className="relative ">
            ...
            <div
                ...
                <div className="px-2 md:px-10 absolute bottom-0 md:bottom-6">
                    <h1 style={{ letterSpacing: "10px" }} className=" text-base md:text-3xl lg:text-6xl text-white font-bold font-[Roboto]">IDENTITY INCLUSION</h1>
                    <p className=" text-white mt-2 lg:mt-7 text-base  md:text-2xl  lg:text-4xl font-[Ubuntu]"> Youth for A  Diverse and Inclusive Society</p>
                </div>
            </div>
        </div>
    );
