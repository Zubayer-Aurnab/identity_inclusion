...
const HomeText = () => {
    return (
        <div className="px-2 lg:px-0">
            <div className=" lg:w-4/5 mx-auto text-justify bg-gradient-to-t my-10 from-[#c0e1bd] to-[#0d7f88]  text-white px-10 py-10 rounded-md ">
                <q
                    style={{
                        letterSpacing: "2px",
                    ...
                    className=" md:text-3xl  font-bold  p-1 "><span className="text-6xl">I</span>dentity Inclusion is a development consulting firm that aims to resolve and
