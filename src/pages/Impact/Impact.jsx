            ...
            <div className=' flex-col lg:flex-row flex  items-center my-10 lg:my-0 '>
                <div className='flex-1'>
                    <div data-aos="fade-right" data-aos-duration="2000" className='pr-0 lg:pr-4 mb-10 lg:mb-0'>
                        <h1 className='text-xl lg:text-2xl xl:text-3xl font-[Roboto] text-[#118088]'>First woman to receive the Stellar Women 2023 award
                        </h1>
                        <p className='font-[Ubuntu]  xl:text-xl text-[#666b73] mt-5 lg:mt-0 xl:mt-5 text-justify'>
            ...
            <div className=' flex-col lg:flex-row-reverse flex  items-center  mb-10'>
                <div className='flex-1  '>
                    <div data-aos="fade-left" data-aos-duration="2000" className='mb-10 lg:mb-0 lg:pl-4'>
                        <h1 className=' text-xl lg:text-2xl xl:text-3xl font-[Roboto] text-[#118088]'>BRAC Urban Innovation Challenge in 2016
                        </h1>
                        <p className='font-[Ubuntu] xl:text-xl text-[#666b73] mt-5 lg:mt-0 xl:mt-5 text-justify'>
