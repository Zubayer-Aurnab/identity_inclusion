...
import { useSupportersQuery } from "../../../Redux/Apis/supportersApi";
const Supporters = () => {
                ...
                >
                    ...
                    <div className="p-5 space-y-3">
                        ...
                        <div className="flex item-c text-gray-500">
                            ...
                            <span className="text-sm flex-1 font-text">{user?.address}</span>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-4 pt-2">
                            <div className="flex items-center text-sm text-gray-600 ">
                                ...
                                <span className="font-text">{user?.education}</span>
                            </div>
                        </div>
                        <div className="text-md font-semibold text-gray-600 ">
                            Tranings
                        </div>
                        <div className=" pb-10 flex flex-wrap gap-2 mt-2">
                            {
                                user?.tranings?.map((training, idx) => (
                                    <div key={training?.id} className=" bg-green-100 text-green-800 flex items-center px-2 rounded-md ">
                                        <svg className="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M6.267 3.455a3.066 3.066 0 001.745-.723 3.066 3.066 0 013.976 0 3.066 3.066 0 001.745.723 3.066 3.066 0 012.812 2.812c.051.643.304 1.254.723 1.745a3.066 3.066 0 010 3.976 3.066 3.066 0 00-.723 1.745 3.066 3.066 0 01-2.812 2.812 3.066 3.066 0 00-1.745.723 3.066 3.066 0 01-3.976 0 3.066 3.066 0 00-1.745-.723 3.066 3.066 0 01-2.812-2.812 3.066 3.066 0 00-.723-1.745 3.066 3.066 0 010-3.976 3.066 3.066 0 00.723-1.745 3.066 3.066 0 012.812-2.812zm7.44 5.252a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        <span className="inline-flex items-center px-2 py-1 rounded-md text-xs font-semibold flex-1 font-text ">
